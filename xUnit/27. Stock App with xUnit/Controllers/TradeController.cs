using _27._Stock_App_with_xUnit.Models;
using Microsoft.AspNetCore.Mvc;
using Microsoft.Extensions.Options;
using ServiceContracts;

namespace _27._Stock_App_with_xUnit.Controllers
{
    [Route("[controller]")]
    public class TradeController : Controller
    {
        ...
        public TradeController(IOptions<TradingOptions> tradingOptions, IStockService stocksService, IFinhubService finnhubService, IConfiguration configuration)
        {
